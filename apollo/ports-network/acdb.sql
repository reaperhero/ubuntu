...
# Create Database
# ------------------------------------------------------------
CREATE DATABASE IF NOT EXISTS Acdb DEFAULT CHARACTER SET = utf8mb4;
...
VALUES
    ('eureka.service.url', 'default', 'http://192.168.50.146:8080/eureka/', 'Eureka服务Url，多个service以英文逗号分隔'),
